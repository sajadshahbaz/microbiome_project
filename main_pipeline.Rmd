...
tb_mean0<-tb_meanMED<-taxonomy.mean.final
for (i in 1:ncol(tb_mean)){ tb_meanMED[,i]= (tb_meanMED[,i]>median(tb_meanMED[,i]))*1.
tb_mean0[,i]= (tb_mean0[,i]>0)*1.
}
```

```{r}
unique(tb_mean0|> unlist())
```
