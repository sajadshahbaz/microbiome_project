...
feature_absence_presence[, colAnys(feature_absence_presence >= frequent_$over90)] -> features_AP_90[[coh]]
}
...
#hist(taxa$JieZ_2017[ decision$JieZ_2017==1 ,"Oribacterium_sinus"], col=rgb(1,0,0), breaks = 30)
hist(taxa$JieZ_2017[ decision$JieZ_2017==0 ,"Oribacterium_sinus"], col=rgb(0,1,0,0.5))#add=TRUE, breaks=30)
