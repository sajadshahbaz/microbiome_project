...
```{r}
max_permIG<- data.frame(IG1D= lapply(perm_full_MDFSres, function(x) max(max(x$res_1D0$statistic), x$res_1Dm$statistic))|>unlist(),
		        IG2D= lapply(perm_full_MDFSres, function(x) max(max(x$res_2D0$statistic), x$res_2Dm$statistic))|>unlist(),
