...
We take random fraction of $1- \frac{1}{e} \approx 0.63$ of total number of the samples and perform feature selection using MDFS and U-test, then we use those features to train random forest classifiers (this corresponds to a jackknife estimation).

Held out data from each run is then used for testing performance of the classififier:
